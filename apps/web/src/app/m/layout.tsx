...
// The v2 surface is phone-first: cover the notch, and paint the status bar the
// same shade as the app so the page reads edge to edge.
...
export default async function V2Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <V2ConfigProvider locale={locale} currency={APP_CURRENCY}>
